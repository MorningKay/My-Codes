...
def get_revealed_letter(secret_word, letters_guessed):
    """
    secret_word: string, the lowercase word the user is guessing
    letters_guessed: list (of lowercase letters), the letters that have been
        guessed so far

    returns: a letter through help to reveal
    """
    choose_from = ''
...
def count_unique_numbers(secret_word):
    record_str = ''
    for i in secret_word:
        if i not in record_str:
            record_str += i
...
def hangman(secret_word, with_help):
    ...
    * If the guess is the symbol !, you should reveal to the user one of the
    ...
    while i > 0 and not has_player_won(secret_word, letters_guessed):
        ...
        if letter == '!':
            ...
            if i < 3:
                ...
                revealed_letter = get_revealed_letter(secret_word, letters_guessed)
    ...
    if has_player_won(secret_word, letters_guessed):
        total_score = i + 4*count_unique_numbers(secret_word) + 3*len(secret_word)
