...
# INSERT CODE HERE
newlist = [e for e in original_list if e%5 != 0]
print(newlist)
...
# INSERT CODE HERE
newlist = [e/2 for e in original_list]
print(newlist)
...
def sort_list_of_lists(lst):
    ...
    the_sorted_list = []
    for i in lst:
        the_sorted_list.append(sorted(i))
...
def split_list(lst, n):
    ...
    """
    # INSERT CODE HERE
    newlist = [lst[i:i+n] for i in range(0,len(lst),n)]
    return newlist
