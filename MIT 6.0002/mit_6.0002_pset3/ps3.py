...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        for i in range(width):
            for j in range(height):
                self.dirt_dict[(i, j)] = dirt_amount
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        pos_x, pos_y = map(lambda x: math.floor(x), (pos.get_x(), pos.get_y()))
        self.dirt_dict[(pos_x, pos_y)] -= capacity
        if self.dirt_dict[(pos_x, pos_y)] < 0:
            self.dirt_dict[(pos_x, pos_y)] = 0
    ...
    def is_position_in_room(self, pos):
        ...
        """
        pos_x, pos_y = pos.get_x(), pos.get_y()
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        pos_x, pos_y = map(lambda x: x * random.random(), (room.width, room.height))
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        pos_x, pos_y = map(lambda x: x * random.random(), (self.width, self.height))
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_furnished(self, pos):
        ...
        """
        pos_x, pos_y = map(lambda x: math.floor(x), (pos.get_x(), pos.get_y()))
        return (pos_x, pos_y) in self.furniture_tiles
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        if room.is_position_valid(new_position):
            room.clean_tile_at_position(new_position, capacity)
...
#       of a 20x20 room?
# A: StandardRobot has a better performance than FaultyRobot.
#
