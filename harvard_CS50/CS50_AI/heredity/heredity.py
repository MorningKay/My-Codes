...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]['mother'] is None:
            ...
            probability *= gene_num_prob * trait_prob
        else:
            ...
            if gene_num == 0:
                ...
                probability *= percentages[mother] * (1 - percentages[father]) + \
                    (1 - percentages[mother]) * percentages[father]
            else:
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for gene_num in probabilities[person]['gene']:
            probabilities[person]['gene'][gene_num] /= gene_total
